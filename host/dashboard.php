...
$query1 = "SELECT * FROM `host_alerts` WHERE userid = $id";
$result1 = mysqli_query($con, $query1);
$data1 = mysqli_num_rows($result1);

$query2 = "SELECT * FROM `host_attendance` WHERE userid = $id";
      ...
      <div id="main">
         ...
         <div id="main-contents">
            ...
            <div class="alert alert-info" role="alert">
               <h5 class="card-title">Mask Alerts</h5>
               <p class="card-text"><?php echo $data1 ?></p>
            </div>
            <div class="alert alert-warning" role="alert">
               <h5 class="card-title">Total Attended Sessions</h5>
