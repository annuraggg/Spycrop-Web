...
$query    = "SELECT * FROM `host_table` ORDER BY personid";
                    ...
                    <table>
                        ...
                        if ($result->num_rows >= 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["personId"] . "</td><td>" . $row["staffid"] . "</td><td>" . $row["fName"] . "</td><td>" . $row["lName"] . "</td><td>" . $row["phone"] . "</td><td>" . $row["email"] . "</td>"  . "</tr>";
                            }
                        }
                        ?>
                    </table>
